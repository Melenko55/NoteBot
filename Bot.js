...
const bot = new TeleBot({
    token: "5054142730:AAFNSdmYg3IOypP3ZBi4qVOjYeCm80ycvA0"
});
...
bot.on('/inlineKeyboard', msg => {
    ...
    let replyMarkup = bot.inlineKeyboard([
        [
            bot.inlineButton('callback', {callback: () => console.log("Hello")}),
...
bot.on('callbackQuery', msg => {
    // User message alert
    return bot.answerCallbackQuery(msg.id, {text: `Inline button callback: ${ msg.data }`});
});
